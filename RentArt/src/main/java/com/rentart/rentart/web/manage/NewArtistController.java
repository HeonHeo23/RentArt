...
public class NewArtistController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ArtistService artistService;
       
    public NewArtistController() {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int last = artistService.getLastId();
		
		request.setAttribute("last", last+1);
		
		request.getRequestDispatcher("/manage/newArtist.jsp").forward(request, response);
	}
}