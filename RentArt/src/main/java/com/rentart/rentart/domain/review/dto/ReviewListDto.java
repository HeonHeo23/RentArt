...
public class ReviewListDto {
	...
	public ReviewListDto(int rownum, int rId, String rTitle, String rContent, int rHits, Timestamp rRegDate,
			Timestamp rUpDate, int userKey, String userName, int pId, String pName, String pImg) {
		this.rownum = rownum;
		this.rId = rId;
		this.rTitle = rTitle;
